                  ...
                  <div className="flex-1 py-6 overflow-y-auto px-4 sm:px-6">
                    <div className="flex items-start justify-between">
                      ...
                      <div className="ml-3 h-7 flex items-center">
                        ...
                        >
                          <span className="sr-only">Stäng varukorg</span>
                              ...
                              {cart.map((product) => (
                                <li key={product.id + Math.random()} className="py-6 flex">
                                  <div className="relative flex-shrink-0 w-24 h-24 border border-gray-200 rounded-md overflow-hidden">
                                    <Link style={{cursor: 'pointer'}} href={`/produkter/${product.handle}`} passHref>
                                    <Image
                                      src={product.image}
                                      alt={product.title}
                                      layout="fill"
                                  ...
                                  <div className="ml-4 flex-1 flex flex-col">
                                    <div>
                                      <div className="flex justify-between text-base font-medium text-gray-900">
                                        <h3>
                                          <Link href={`/produkter/${product.handle}`} passHref>
                                    ...
                                    <div className="flex-1 flex items-end justify-between text-sm">
                                      <p className="text-gray-500">Antal {product.variantQuantity}</p>
                  ...
                  </div>
                  {
                    cart.length > 0 ?
                      <div className="border-t border-gray-200 py-6 px-4 sm:px-6">
                        ...
                        <p className="mt-0.5 text-sm text-gray-500">Leveransavgift och skatt räknas ut i kassan.</p>
                        <div className="mt-6">
                          <a
                            href={checkoutUrl}
